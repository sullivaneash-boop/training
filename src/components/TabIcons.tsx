...
export function IconWeek({ className = '' }: IconProps) {
  return (
    <svg className={`${base} ${className}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 19V5M8 19V9M12 19V13M16 19V7M20 19V3" />
    </svg>
  );
}
...
export function IconCoach({ className = '' }: IconProps) {
  return (
    <svg className={`${base} ${className}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" aria-hidden>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 19h14M8 16h8" />
    </svg>
  );
}
